...
<!--begin::Dashboard 1-->
    <div class="k-portlet">
       <div class="k-portlet__head">
        ...
        <form method="POST" action="{{ URL::route('ad_documents.documents.update', $data['document']->doc_id) }}"  class="k-form k-form--label-right" id='partners_blocks'>
              {{ @csrf_field() }}
               @method('PUT') 
                ...
                <div class='documents' id='duplicater'>
                    <div class="form-group row">
                        ...
                        @foreach($data['subcategories'] as $sub)
                            <option @if($data['document']->subcategory_id == $sub->subcategory_id) selected @endif value="{{$sub->subcategory_id}}">{{$sub->title}}</option>
                        @endforeach    
                        </select> 
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            <input type="text" class="form-control" placeholder="" name="title" value="{{$data['document']->title}}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-lg-6 col-md-9 col-sm-12">
                            <input type="text" class="form-control" name="link" placeholder="" value="{{$data['document']->file_link}}">
