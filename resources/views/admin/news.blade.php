    ...
    <div class="k-portlet">
       <div class="k-portlet__head">
            <div class="k-portlet__head-label">
                ...
                <a href="{{ URL::route('ad_news.news.create') }}" class="btn btn-brand k-btn k-btn--icon but-plus" id="m_plus">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a class="btn btn-sm btn-clean btn-icon btn-icon-md delete_new" title="View">
