...
$.validator.addMethod( "dateSec", function( value, element ) {
	return this.optional( element ) || "/^(3[01]|[12][0-9]|0[1-9])/(1[0-2]|0[1-9])/[0-9]{4} (2[0-3]|[01]?[0-9]):([0-5]?[0-9]):([0-5]?[0-9])$/".test( value );
}, $.validator.messages.date );
