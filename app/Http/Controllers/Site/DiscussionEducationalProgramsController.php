...
class DiscussionEducationalProgramsController extends Controller
{
    public function index(Request $request){
        $locale = $request['locale'];
        $subcategory = DB::table("subcategory")->where('link','discussion-educational-programs')->get()->toArray();
...
//        $documents = DB::table('documents')->get()->toArray();
        ...
        $subCategories = DB::table('subcategory')
            ->where('link', 'discussion-educational-programs')
