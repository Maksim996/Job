    ...
    public function update(Request $request, $id)
    {
        ...
        $changedId = $id != 0 ?
                ...
                DB::table('documents')->insertGetId([
                    ...
                    'placeholder_ua' => $request->placeholder_ua ?  $request->placeholder_ua : null,
                    'placeholder_ru' => $request->local_ru ? $request->placeholder_ru : null,
                    'placeholder_us' => $request->local_us ? $request->placeholder_us : null,
                    'file_link' => '-' ,
